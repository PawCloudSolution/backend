...
export const AppDataSource = new DataSource({
  type: 'postgres',
  url: process.env.DATABASE_URL || 'postgresql://postgres:postgres@localhost:5432/paw_cloud',
  synchronize: true, // Auto create tables based on entities for development
  logging: false,
  entities: [UserEntity, OrganizationEntity, OrganizationApplicationEntity],
  migrations: [],
  subscribers: [],
});
